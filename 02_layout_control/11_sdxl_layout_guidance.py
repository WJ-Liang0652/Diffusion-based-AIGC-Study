"""Run a baseline and a first training-free SDXL layout-guided denoising experiment."""
...
with (OUTPUT_DIR / "guided_timestep_metrics.csv").open("w", newline="") as file:
...
ax.axis("off")
overlay_path = OUTPUT_DIR / "controlled_seed42_target_box_reference.png"
